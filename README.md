...
- **Language Support**: Localized in **English**, **Turkish**, and **German** for international accessibility.
...
- **Trial-Specific PPI Persistence**: Every individual trial records the exact PPI and DPR at the moment of drawing. This ensures that historical trial calculations remain mathematically intact even if settings are adjusted mid-session.
...
- **Screen Locking**: During the active test, the system locks scrolling to prevent accidental viewport movement and maintain participant focus.
...
The system automatically detects and applies high-precision logical PPI values for modern iPad hardware:
- iPad Pro 12.9": **132.5 PPI**
- iPad Pro 11" / Air: **132.0 PPI**
- iPad Mini (6th Gen): **163.0 PPI**
...
- **Stroke Status**: For database submissions, confirming stroke history (Yes/No) is mandatory, enabling stratified clinical analysis.
...
- **Text Label**: `±pct (cm)` based on trial-specific PPI.
